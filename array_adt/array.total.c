...
int main(){ 
    ...
    scanf("%d", &arr1.size);   // takes user input from the keyboard.
    arr1.A=(int *)malloc(arr1.size*sizeof(int));    // creates the dynamic array of the desired size in heap memory.
